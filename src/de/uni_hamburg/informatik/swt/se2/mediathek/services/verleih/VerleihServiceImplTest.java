...
/**
 * TODO für Blatt 1 und 2: Löschen da er auf Blatt 1 sonst fehlschlägt und die
 * Studierenden für Blatt 2 eine abgespeckte Vorlage erhalten
 * 
 * @author SE2-Team
 */
...
//            }
//        };
        PropertyChangeListener beobachter = new PropertyChangeListener() {
            @Override
    ...
    @Test
    public void testeVormerkenundVormerkenentfernen()
            throws ProtokollierException
    {

        List<Medium> vormerkMedien = _medienListe.subList(2, 4);

        assertTrue(_service.koennenAlleVorgemerktWerdenVon(_vormerkkunde,
                _medienListe));

        _service.merkeVor(_vormerkkunde, vormerkMedien);

        assertFalse(_service.koennenAlleVorgemerktWerdenVon(_vormerkkunde,
                _medienListe));
        assertFalse(_service.koennenAlleVorgemerktWerdenVon(_vormerkkunde,
                vormerkMedien));
        ...
        _service.entferneVormerker(_vormerkkunde, vormerkMedien);
