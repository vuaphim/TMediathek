...
class MediathekUI
{
    ...
    public static final String NAME = "SE2-Mediathek 2014";
    public static final String RUECKGABE = "Rückgabe-Ansicht";
    public static final String VORMERKEN = "Vormerk-Ansicht";
    public static final String MEDIENVERWALTUNG = "Medienverwaltung";
    ...
    private JButton _medienverwaltungsButton;
    private JPanel _medienverwaltungsPanel;
    ...
    public MediathekUI(JPanel ausleihePanel, JPanel rueckgabePanel,
            JPanel vormerkPanel, JPanel medienverwaltungsPanel)
    {
        ...
        assert medienverwaltungsPanel != null : "Vorbedingung verletzt: medienverwaltungsPanel != null";
        _ausleihePanel = ausleihePanel;
        _rueckgabePanel = rueckgabePanel;
        _vormerkPanel = vormerkPanel;
        _medienverwaltungsPanel = medienverwaltungsPanel;
        initGUI();
    }
    ...
    private void erzeugeAnzeigePanel()
    {
        ...
        _anzeigePanel.add(_medienverwaltungsPanel, MEDIENVERWALTUNG);
    ...
    /**
     * Erzeugt den Medienverwaltungs-Button für das Menü.
     */
    private void erzeugeMedienverwaltungsButton()
    {
        _medienverwaltungsButton = new JButton();
        initialisiereMenuButton(_medienverwaltungsButton, MEDIENVERWALTUNG);
    }
    ...
    private void erzeugeMenuPanel()
    {
        ...
        erzeugeMedienverwaltungsButton();
        erzeugeTitel();
    }
    ...
    private void zeigeAn(String werkzeugName)
    {
        ...
        else if (werkzeugName.equals(MEDIENVERWALTUNG))
        {
            buttonToSelect = getMedienverwaltungsButton();
            buttonToDeselect = getSelectedButton();
        }
        else
        {
    ...
    /**
     * Gibt den Medienverwaltungs-Button zurück.
     * 
     * @return Den Medienverwaltungs-Button.
     */
    public JButton getMedienverwaltungsButton()
    {
        return _medienverwaltungsButton;
    }
    ...
    /**
     * Zeigt die Medienverwaltungs-Ansicht
     */
    public void zeigeMedienverwaltung()
    {
        zeigeAn(MediathekUI.MEDIENVERWALTUNG);
    }
